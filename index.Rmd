...
## R Markdown Tutorial 
### **Still under construction**; mainly for me to learn R
...
**Whenever I pust double astericks around text it highlights it**
...
When I first started using R Markdown, the shortcust Ctrl + Alt + I (OS X: Cmd + Option + I) really helped.  For more on Code Chunks, here is a link to a R Markdown codechunk cheatsheet. 
...
To add images type an exclamation point![caption](directory/image.png/jpeg
 

![I stan BTS](/users/jen/desktop/trials/Bts.png)
 To embed a video
 
suggest_embed("https://youtu.be/pBuZEGYXA6E?t=1m32s")
#> embed_youtube("pBuZEGYXA6E") %>%
#> use_start_time("1m32s")

embed_youtube(https://www.youtube.com/embed/pBuZEGYXA6E, width = 420, height = 315, frameborder = 0,
allowfullscreen = False, query = NULL)

embed_url("https://www.youtube.com/embed/pBuZEGYXA6E")
