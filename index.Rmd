...
```{r video, echo=FALSE}
("The one that worked for me was the '<iframe src=URL, width=420, height=315, frameborder=0, allowfullscreen, use_start_time(ms)> </iframe>' option with double quotations around each answer")
```
 
<iframe src="https://www.youtube.com/embed/pBuZEGYXA6E" width="420" height="315" frameborder="0" allowfullscreen, use_start_time("1m25s")> </iframe>

<iframe src="https://www.youtube.com/embed/pBuZEGYXA6E" width="420" height="315" frameborder="0" allowfullscreen> </iframe>


 To hyperlink a word, type the word in [] and then in brackets() paste the link
